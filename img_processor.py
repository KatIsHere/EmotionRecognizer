...
def detect_and_classify(img, model, conf_threshold = 0.97, new_size=None, channels=1,
...
def validate_on_database(csv_filename, model_filename, n_classes, im_shape, label_map, channels=1):
