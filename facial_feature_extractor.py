...
class Facial_Feature_Net:
    ...
    def init_model(self, input_shape, n_classes):
        ...
        self._model.add(Conv2D(24, (5, 5), padding = "same", input_shape = input_shape, activation = 'relu'))
        ...
        self._model.add(Conv2D(64, (3, 3), padding = "same", input_shape = input_shape, activation = 'relu'))
        self._model.add(GlobalAveragePooling2D(pool_size = (2, 2), strides = (2, 2), padding = "same"))
